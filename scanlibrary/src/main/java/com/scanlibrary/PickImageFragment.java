...
//                        "com.example.imagedemoexample" + ".provider",getOutputMediaFile(1));
                Uri tempFileUri = FileProvider.getUriForFile(getActivity().getApplicationContext(),
                        "com.scanlibrary.provider", // As defined in Manifest
                        file);
//                Uri tempFileUri=   FileProvider.getUriForFile(Objects.requireNonNull(getContext()),
//                        "com.scanlibrary.provider" + ".provider", file);
                fileUri=tempFileUri;
